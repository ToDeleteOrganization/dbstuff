 ...
 */
public class TagPairDefinition extends AbstractSkeletonItem {
...
//    private int id;
    ...
    protected void copyPropertiesTo(MetaData clone) {
    	TagPairDefinition tagPairDef = super.convertType(clone);
    	if (tagPairDef != null) {
    		super.copyPropertiesTo(tagPairDef);
    		tagPairDef.setStartTagDisplayText(startTagDisplayText);
    		tagPairDef.setStartTagContent(startTagContent);
    		tagPairDef.setEndTagDisplayText(endTagDisplayText);
    		tagPairDef.setEndTagContent(endTagContent);
    		tagPairDef.setCanHide(canHide);
    		tagPairDef.setSegmentationHint(segmentationHint);
    		tagPairDef.setFormattingGroupId(formattingGroupId);
    		tagPairDef.setSubContent(Utils.deepCloneList(subContent));
    	}
    }

    @Override
    public TagPairDefinition deepClone() {
    	TagPairDefinition tagPairDef = new TagPairDefinition();
    	copyPropertiesTo(tagPairDef);
    	return tagPairDef;
    }
