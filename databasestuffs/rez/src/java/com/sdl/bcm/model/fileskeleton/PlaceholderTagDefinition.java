 ...
 */
public class PlaceholderTagDefinition extends AbstractSkeletonItem {
...
//    private int id;
    ...
    protected void copyPropertiesTo(MetaData clone) {
    	PlaceholderTagDefinition placeTag = super.convertType(clone);
    	if (placeTag != null) {
    		super.copyPropertiesTo(placeTag);
    		placeTag.setDisplayText(displayText);
    		placeTag.setTagContent(tagContent);
    		placeTag.setTextEquivalent(textEquivalent);
    		placeTag.setSegmentationHint(segmentationHint);
    		placeTag.setSubContent(Utils.deepCloneList(subContent));
    	}
    }

    @Override
    public PlaceholderTagDefinition deepClone() {
    	PlaceholderTagDefinition placeHoldTagDef = new PlaceholderTagDefinition();
    	copyPropertiesTo(placeHoldTagDef);
    	return placeHoldTagDef;
    }
