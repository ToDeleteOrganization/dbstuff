...
public class CommentDefinition extends AbstractSkeletonItem {
    ...
    protected void copyPropertiesTo(MetaData clone) {
    	CommentDefinition commentDefinition = super.convertType(clone);
    	if (commentDefinition != null) {
    		super.copyPropertiesTo(commentDefinition);
    		commentDefinition.setAuthor(author);
    		commentDefinition.setCommentSeverity(commentSeverity);
    		commentDefinition.setDate(date);
    		commentDefinition.setText(text);
    	}
    }
